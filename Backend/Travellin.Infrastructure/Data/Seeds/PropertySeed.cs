...
namespace Travellin.Infrastructure.Data.Seeds
{
    ...
    {
        // Helper method to get a descriptive property type name
        private static string GetPropertyTypeName(int propertyTypeId)
        {
        ...
        // Helper method to get a descriptive location name
        private static string GetLocationName(int locationId)
        {
            return locationId switch
            {
                ...
                4 => "California, USA", // Hawkeye Dome
                5 => "Salvador, Brazil",
                6 => "Barcelona, Spain",
                7 => "Wadi Rum, Jordan",
                8 => "French Alps", // Mountain View
                9 => "Azores, Portugal", // Mill House
                10 => "Icheon-si, South Korea", // near Seoul
                11 => "Cape Town, South Africa", // Kai Cottage
                12 => "Maadi, Cairo, Egypt",
                13 => "Merville, BC, Canada", // Wetland Views
                14 => "Virginia Beach, USA", // Beachfront Oasis
                15 => "Gammarth, Tunisia", // Sea View
                16 => "English Countryside",
                17 => "Buenos Aires, Argentina",
                18 => "Lekki Phase 1, Nigeria",
                19 => "Lam Thuong, Vietnam",
                20 => "Dubai, UAE",
                21 => "Atlas Mountains, Morocco",
                22 => "Bogotá, Colombia", // Treehouse
                23 => "Ubud, Bali, Indonesia",
                24 => "Rome, Italy",
                25 => "Bodrum, Turkey",
                _ => "Unknown Location"
            };
        ...
        public static List<Property> Data => new()
        {
            new Property
            {
                ...
                PropertyTypeId = 1,
                Title = $"Stunning {GetPropertyTypeName(1)} in {GetLocationName(1)}", // New Title
                IsInstantBook = false // Example: Requires host approval
            },
            new Property
            {
                ...
                OwnerId = "3dacdb51-fee9-4479-904c-cafe7dca22a7",
                PropertyTypeId = 3,
                Title = $"Elegant {GetPropertyTypeName(3)} in {GetLocationName(2)}",
                IsInstantBook = true // Example: Instant book
            },
            new Property
            {
                ...
                OwnerId = "3dacdb51-fee9-4479-904c-cafe7dca22a7",
                PropertyTypeId = 1,
                Title = $"Peaceful {GetPropertyTypeName(1)} in {GetLocationName(3)}",
                IsInstantBook = false
            },
            new Property
            {
                ...
                OwnerId = "3dacdb51-fee9-4479-904c-cafe7dca22a7",
                PropertyTypeId = 2,
                Title = $"Epic Glamping {GetPropertyTypeName(2)} in {GetLocationName(4)}",
                IsInstantBook = true
            },
            new Property
            {
                ...
                OwnerId = "3dacdb51-fee9-4479-904c-cafe7dca22a7",
                PropertyTypeId = 1,
                Title = $"Charming Oceanfront {GetPropertyTypeName(1)} in {GetLocationName(5)}",
                IsInstantBook = false
            },
            new Property
            {
                ...
                OwnerId = "3dacdb51-fee9-4479-904c-cafe7dca22a7",
                PropertyTypeId = 1,
                Title = $"Modern {GetPropertyTypeName(1)} in {GetLocationName(6)}",
                IsInstantBook = true
            },
            new Property
            {
                ...
                OwnerId = "3dacdb51-fee9-4479-904c-cafe7dca22a7",
                PropertyTypeId = 1,
                Title = $"Authentic Cave {GetPropertyTypeName(1)} in {GetLocationName(7)}",
                IsInstantBook = false
            },
            new Property
            {
                ...
                OwnerId = "3dacdb51-fee9-4479-904c-cafe7dca22a7",
                PropertyTypeId = 1,
                Title = $"Designer {GetPropertyTypeName(2)} in {GetLocationName(8)}",
                IsInstantBook = true
            },
            new Property
            {
                ...
                OwnerId = "3dacdb51-fee9-4479-904c-cafe7dca22a7",
                PropertyTypeId = 4,
                Title = $"Romantic {GetPropertyTypeName(4)} in {GetLocationName(9)}",
                IsInstantBook = false
            },
            new Property
            {
                ...
                OwnerId = "3dacdb51-fee9-4479-904c-cafe7dca22a7",
                PropertyTypeId = 1,
                Title = $"Unique {GetPropertyTypeName(2)} near {GetLocationName(10)}",
                IsInstantBook = true
            },
            new Property
            {
                ...
                OwnerId = "3dacdb51-fee9-4479-904c-cafe7dca22a7",
                PropertyTypeId = 1,
                Title = $"Serene {GetPropertyTypeName(4)} in {GetLocationName(11)}",
                IsInstantBook = false
            },
            new Property
            {
                ...
                OwnerId = "3dacdb51-fee9-4479-904c-cafe7dca22a7",
                PropertyTypeId = 2,
                Title = $"Charming {GetPropertyTypeName(2)} in {GetLocationName(12)}",
                IsInstantBook = true
            },
            new Property
            {
                ...
                OwnerId = "3dacdb51-fee9-4479-904c-cafe7dca22a7",
                PropertyTypeId = 4,
                Title = $"Beautiful {GetPropertyTypeName(4)} in {GetLocationName(13)}",
                IsInstantBook = false
            },
            new Property
            {
                ...
                OwnerId = "3dacdb51-fee9-4479-904c-cafe7dca22a7",
                PropertyTypeId = 3,
                Title = $"Beachfront {GetPropertyTypeName(3)} in {GetLocationName(14)}",
                IsInstantBook = true
            },
            new Property
            {
                ...
                OwnerId = "3dacdb51-fee9-4479-904c-cafe7dca22a7",
                PropertyTypeId = 4,
                Title = $"Luxury {GetPropertyTypeName(1)} in {GetLocationName(15)}",
                IsInstantBook = false
            },
            new Property
            {
                ...
                OwnerId = "3dacdb51-fee9-4479-904c-cafe7dca22a7",
                PropertyTypeId = 1,
                Title = $"Charming {GetPropertyTypeName(4)} in {GetLocationName(16)}",
                IsInstantBook = true
            },
            new Property
            {
                ...
                OwnerId = "3dacdb51-fee9-4479-904c-cafe7dca22a7",
                PropertyTypeId = 2,
                Title = $"Stylish {GetPropertyTypeName(2)} in {GetLocationName(17)}",
                IsInstantBook = false
            },
            new Property
            {
                ...
                OwnerId = "3dacdb51-fee9-4479-904c-cafe7dca22a7",
                PropertyTypeId = 1,
                Title = $"Luxe {GetPropertyTypeName(1)} in {GetLocationName(18)}",
                IsInstantBook = true
            },
            new Property
            {
                ...
                OwnerId = "3dacdb51-fee9-4479-904c-cafe7dca22a7",
                PropertyTypeId = 4,
                Title = $"Authentic {GetPropertyTypeName(4)} in {GetLocationName(19)}",
                IsInstantBook = false
            },
            new Property
            {
                ...
                OwnerId = "3dacdb51-fee9-4479-904c-cafe7dca22a7",
                PropertyTypeId = 1,
                Title = $"Modern {GetPropertyTypeName(1)} in {GetLocationName(20)}",
                IsInstantBook = true
            },
            new Property
            {
                ...
                OwnerId = "3dacdb51-fee9-4479-904c-cafe7dca22a7",
                PropertyTypeId = 2,
                Title = $"Comfortable {GetPropertyTypeName(2)} in {GetLocationName(21)}",
                IsInstantBook = false
            },
            new Property
            {
                ...
                OwnerId = "3dacdb51-fee9-4479-904c-cafe7dca22a7",
                PropertyTypeId = 4,
                Title = $"Spectacular {GetPropertyTypeName(4)} in {GetLocationName(22)}",
                IsInstantBook = true
            },
            new Property
            {
                ...
                OwnerId = "3dacdb51-fee9-4479-904c-cafe7dca22a7",
                PropertyTypeId = 1,
                Title = $"Peaceful {GetPropertyTypeName(2)} in {GetLocationName(23)}",
                IsInstantBook = false
            },
            new Property
            {
                ...
                OwnerId = "3dacdb51-fee9-4479-904c-cafe7dca22a7",
                PropertyTypeId = 3,
                Title = $"Modern {GetPropertyTypeName(3)} in {GetLocationName(24)}",
                IsInstantBook = true
            },
            new Property
            {
                ...
                OwnerId = "3dacdb51-fee9-4479-904c-cafe7dca22a7",
                PropertyTypeId = 2,
                Title = $"Beachfront {GetPropertyTypeName(3)} in {GetLocationName(25)}",
                IsInstantBook = false
            }
        };
    }
