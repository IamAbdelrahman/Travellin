...
namespace Travellin.Core.Interfaces
{
    public interface IPropertyRepository : IGenericRepository<Property, string>
    {
        ...
        public Task<PaginatedResult<PropertyListItemDto>> GetPropertiesByOwnerIdAsync(FilterPropertyQueryParamsDto queryDto, string userId);
        public Task<bool> UpdateAsync(string propertyId, PropertyUpdateDto dto);
    }
